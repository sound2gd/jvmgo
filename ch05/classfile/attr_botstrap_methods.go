...
type BootstrapMethodsAttribute struct {
	bootstrapMehods []*BootstrapMethod
}
...
func (self *BootstrapMethodsAttribute) readInfo(reader *ClassReader) {
	...
	self.bootstrapMehods = make([]*BootstrapMethod, numBootstrapMethods)
	for i := range self.bootstrapMehods {
		self.bootstrapMehods[i] = &BootstrapMethod{
